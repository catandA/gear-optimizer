                        ...
                        <td>
                            <label>
                                <input style={{
                                    width: '100px',
                                    margin: '5px'
                                }} type="number" step="any" value={this.props.hackstats['rpow']}
                                       onFocus={this.handleFocus} onChange={(e) => this.handleChange(e, 'rpow')}/>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <label>
                                <input style={{
                                    width: '100px',
                                    margin: '5px'
                                }} type="number" step="any" value={this.props.hackstats['rcap']}
                                       onFocus={this.handleFocus} onChange={(e) => this.handleChange(e, 'rcap')}/>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <label>
                                <input style={{
                                    width: '100px',
                                    margin: '5px'
                                }} type="number" step="any" value={this.props.hackstats.hackspeed}
                                       onFocus={this.handleFocus} onChange={(e) => this.handleChange(e, 'hackspeed')}/>
                            </label>
                        </td>
                        <td>
                            <input type="checkbox" checked={this.props.hackstats.lockSpeed}
                        ...
                        <td>
                            <label>
                                <input style={{
                                    width: '100px',
                                    margin: '5px'
                                }} type="number" step="any" value={hacktime} onFocus={this.handleFocus}
                        ...
                        <td>
                            <label key='hackoption'>
                                <select value={this.state.hackoption}
                                        onChange={(e) => this.handleChange(e, 'hackoption')}>
                                    {
                                ...
                                <td>
                                    <label>
                                        <input style={{
                                            width: '40px',
                                            margin: '5px'
                                        }} type="number" step="any" value={reducer} onFocus={this.handleFocus}
                                ...
                                <td>
                                    <label>
                                        <input style={{
                                            width: '60px',
                                            margin: '5px'
                                        }} type="number" step="any" value={level} onFocus={this.handleFocus}
                                ...
                                <td className={classTarget}>
                                    <label>
                                        <input style={{
                                            width: '60px',
                                            margin: '5px'
                                        }} type="number" step="any" value={target} onFocus={this.handleFocus}
